defmodule EWallet.ReleaseTasks do
  ...
  @seed_std_spec [{:ewallet_db, :seeds_settings}, {:ewallet_db, :seeds}]
  @seed_e2e_spec [{:ewallet_db, :seeds_settings}, {:ewallet_db, :seeds_test}]
  ...
  @initdb_apps [:ewallet_config, :ewallet_db, :local_ledger_db]
